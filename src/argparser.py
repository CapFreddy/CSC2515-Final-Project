...
def parse_args():
    ...
    parser.add_argument('--domain_dim', type=int, default=64)
    ...
    parser.add_argument('--num_latent_epochs', type=int, default=200)
    ...
    params = f'domain_dim_{args.domain_dim}-alpha_{args.alpha}'
    if args.finetune:
        params += f'-finetune'
    args.logdir = os.path.join(args.logdir, params, f'seed_{args.seed}', args.target_domain)
